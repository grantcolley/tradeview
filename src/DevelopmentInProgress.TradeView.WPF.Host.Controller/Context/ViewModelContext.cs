...
namespace DevelopmentInProgress.TradeView.Wpf.Host.Controller.Context
{
    ...
    /// It inherits from base abstract class <see cref="ContextBase"/>.
    /// </summary>
    public class ViewModelContext : ContextBase, IViewModelContext
    {
        /// <summary>
        ...
        public ViewModelContext(IUnityContainer unityContainer, ILogger logger)
