...
namespace DevelopmentInProgress.Wpf.MarketView.Services
{
    ...
    {
        Task<IEnumerable<string>> CancelAllOrdersAsync(Interface.User user, string symbol = null, long recWindow = 0, CancellationToken cancellationToken = default(CancellationToken));
